...
const Video = () => {
  const [dataVideo, setDataVideo] = useState(
    data.filter((data) => data.category === "Movie")
  );
        ...
        {dataVideo.length >= 1 ? (
          ...
          <div className="errorHandler">
            ...
            >
              ...
              <path d="M14 12v-2a1 1 0 0 0-2 0v2a1 1 0 0 0 2 0zM20 12v-2a1 1 0 0 0-2 0v2a1 1 0 0 0 2 0zM9.2 20.4a1 1 0 1 0 1.6 1.2A6.79 6.79 0 0 1 16 19a6.81 6.81 0 0 1 5.2 2.6 1 1 0 0 0 .8.4 1 1 0 0 0 .6-.2 1 1 0 0 0 .2-1.4A8.74 8.74 0 0 0 16 17a8.76 8.76 0 0 0-6.8 3.4z" />
            </svg>
